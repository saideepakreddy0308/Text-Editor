...
const TextForm = props => {
  ...
  return (
    <div className='container' style={{color: props.mode==='dark'?'white':'#042743'}}>
        ...
        <div className="mb-3">
        <textarea className="form-control" value={text} onChange={handleOnChange} id="myBox" rows="7" placeholder="Enter text here"
        ...
        <div className="container my-3" style={{color: props.mode==='dark'?'white':'#042743'}}>
            ...
            <p>Approx Time: {0.008 * text.split(/\s+/).filter((element)=>{return element.length!==0}).length} Minutes read</p>
            <h2>Preview</h2>
